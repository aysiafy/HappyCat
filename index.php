      ...
      <div class="row pricing-table-style">
        <div class="col-lg-4 col-md-6 mt-3" data-aos="fade-up" data-aos-duration="1000">
          <div class="card">
            ...
            <div class="card-body">
              <h2 class="pricing-header-style">Gratis Pemakaian satu bulan</h2>
              <p>Grooming</p>
              <p>Tes Virus</p>
              <?php if (isset($_SESSION["username"])) { ?>
        ...
        <div class="col-lg-4 col-md-6 mt-3" data-aos="fade-up" data-aos-duration="1000">
          <div class="card">
            ...
            <div class="card-body">
              <h2 class="pricing-header-style">Rp. 200.000 / bulan</h2>
              <p>Grooming</p>
              <p>Cek Kesehatan</p>
              <p>Penyembuhan</p>
              <?php if (isset($_SESSION["username"])) { ?>
        ...
        <div class="col-lg-4 col-md-12 mt-3" data-aos="fade-up" data-aos-duration="1000">
          <div class="card">
            ...
            <div class="card-body">
              <h2 class="pricing-header-style">Rp. 350.000 / bulan</h2>
              <p>Grooming</p>
              <p>Perawatan Kuku</p>
              <p>Cek Kesehatan</p>
              <p>Penyembuhan</p>
